...
async function getDamageTakenEventsDuringTimestamp(
...
async function getReportDamageTakenEventsForFight(
...
async function getReportDamageTakenEvents(
...
async function makeReportDamageTakenEventIngestible(
...
async function addIngestibleDamageTakenEventsToReport(
  report: ReportWithIngestedFights,
  timings: Timings,
...
async function ingestDamageTakenEvent(
...
async function ingestDamageTakenEventsForReport(
...
export async function ingestDamageTakenEvents(
  report: ReportWithIngestedFights,
  timings: Timings,
