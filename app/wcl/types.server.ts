...
export interface GetFightsQuery { __typename?: 'Query', reportData?: { __typename?: 'ReportData', report?: { __typename?: 'Report', title: string, startTime: number, endTime: number, region?: { __typename?: 'Region', slug: string } | null, fights?: Array<{ __typename?: 'ReportFight', id: number, startTime: number, endTime: number, difficulty?: number | null, encounterID: number, friendlyPlayers?: Array<number | null> | null } | null> | null } | null } | null }
...
export interface GetFightsByIdQuery { __typename?: 'Query', reportData?: { __typename?: 'ReportData', report?: { __typename?: 'Report', title: string, startTime: number, endTime: number, region?: { __typename?: 'Region', slug: string } | null, fights?: Array<{ __typename?: 'ReportFight', id: number, startTime: number, endTime: number, difficulty?: number | null, encounterID: number, friendlyPlayers?: Array<number | null> | null } | null> | null } | null } | null }
...
export interface GetCombatantInfoEventsQuery { __typename?: 'Query', reportData?: { __typename?: 'ReportData', report?: { __typename?: 'Report', title: string, startTime: number, endTime: number, region?: { __typename?: 'Region', slug: string } | null, events?: { __typename?: 'ReportEventPaginator', data?: any | null, nextPageTimestamp?: number | null } | null } | null } | null }
...
export interface GetPlayerDetailsQuery { __typename?: 'Query', reportData?: { __typename?: 'ReportData', report?: { __typename?: 'Report', title: string, startTime: number, endTime: number, playerDetails?: any | null, region?: { __typename?: 'Region', slug: string } | null } | null } | null }
...
export interface GetPhysicalDamageTakenEventsQuery { __typename?: 'Query', reportData?: { __typename?: 'ReportData', report?: { __typename?: 'Report', events?: { __typename?: 'ReportEventPaginator', data?: any | null, nextPageTimestamp?: number | null } | null } | null } | null }
...
export const GetPhysicalDamageTakenEventsDocument = gql`
    query getPhysicalDamageTakenEvents($reportID: String!, $startTime: Float!, $endTime: Float!) {
  reportData {
    report(code: $reportID) {
      events(
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    getFights(variables: GetFightsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetFightsQuery> {
      return withWrapper(wrappedRequestHeaders => client.request<GetFightsQuery>(GetFightsDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }), 'getFights', 'query');
    },
    getFightsById(variables: GetFightsByIdQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetFightsByIdQuery> {
      return withWrapper(wrappedRequestHeaders => client.request<GetFightsByIdQuery>(GetFightsByIdDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }), 'getFightsById', 'query');
    },
    getCombatantInfoEvents(variables: GetCombatantInfoEventsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetCombatantInfoEventsQuery> {
      return withWrapper(wrappedRequestHeaders => client.request<GetCombatantInfoEventsQuery>(GetCombatantInfoEventsDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }), 'getCombatantInfoEvents', 'query');
    },
    getPlayerDetails(variables: GetPlayerDetailsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetPlayerDetailsQuery> {
      return withWrapper(wrappedRequestHeaders => client.request<GetPlayerDetailsQuery>(GetPlayerDetailsDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }), 'getPlayerDetails', 'query');
    },
    getPhysicalDamageTakenEvents(variables: GetPhysicalDamageTakenEventsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetPhysicalDamageTakenEventsQuery> {
      return withWrapper(wrappedRequestHeaders => client.request<GetPhysicalDamageTakenEventsQuery>(GetPhysicalDamageTakenEventsDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }), 'getPhysicalDamageTakenEvents', 'query');
    },
  };
}
