...
export type ViewModelsTranslationsArgs = {
  keys?: InputMaybe<Array<InputMaybe<Scalars["String"]["input"]>>>;
};
...
export type GetPlayerDetailsQuery = {
  __typename?: "Query";
  reportData?: {
    __typename?: "ReportData";
    report?: {
...
export const GetFightsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getFights" },
      variableDefinitions: [
        {
                      ...
                      },
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "friendlyPlayers" },
                            },
                          ],
                        },
                      },
...
} as unknown as DocumentNode<GetFightsQuery, GetFightsQueryVariables>;
export const GetFightsByIdDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getFightsById" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
} as unknown as DocumentNode<GetFightsByIdQuery, GetFightsByIdQueryVariables>;
...
>;
export const GetPlayerDetailsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getPlayerDetails" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
>;
export const GetPhysicalDamageTakenEventsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getPhysicalDamageTakenEvents" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
                        ...
                        arguments: [
                          {
                            kind: "Argument",
                            name: { kind: "Name", value: "dataType" },
                            value: { kind: "EnumValue", value: "DamageTaken" },
                          },
                          {
                            kind: "Argument",
                            name: { kind: "Name", value: "endTime" },
                          ...
                          {
                            kind: "Argument",
                            name: { kind: "Name", value: "filterExpression" },
                            value: {
                              kind: "StringValue",
                              value: "ability.type = 1",
                              block: false,
                            },
                          },
                          {
